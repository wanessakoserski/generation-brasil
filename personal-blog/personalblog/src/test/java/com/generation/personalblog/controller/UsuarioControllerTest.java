...
public class UsuarioControllerTest {
	...
	public void naoDeveDuplicarUsuario() {
		usuarioService.RegisterUser(new Usuario(0L, "Maria Silva", "maria@gmail.com", "maria1234"));
	...
	public void deveAtualizarUmUsuario() {
		Optional<Usuario> usuarioCreate = usuarioService.RegisterUser(new Usuario(0L, "Juliana Andrews", "juliana_andrews@gmail.com", "juliana123"));
	...
	public void deveMostrarTodosUsuarios( ) {
		usuarioService.RegisterUser(new Usuario(0L, "Sabrina Sanches", "sabrina_sanches@gmail.com", "sabrina123"));
		usuarioService.RegisterUser(new Usuario(0L, "ricardo Marques", "ricardo_marques@gmail.com", "ricardo123"));
